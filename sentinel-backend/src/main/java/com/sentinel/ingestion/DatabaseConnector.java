 ...
 *
 * Connections are configured via {@code sentinel.db-targets.targets[]} (env-driven).
 */
@Slf4j
@Component
...
public class DatabaseConnector {
    ...
    private final Map<String, SentinelProperties.DbTargetsConfig.Target> targetsByName = new ConcurrentHashMap<>();
    ...
    private DataSource buildPool(SentinelProperties.DbTargetsConfig.Target target) {
        ...
        cfg.setPoolName("sentinel-ro-" + target.getName());
