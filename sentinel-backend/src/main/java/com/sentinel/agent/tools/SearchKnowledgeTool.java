...
public class SearchKnowledgeTool implements AgentTool {
    ...
    public String description() {
        return "Search the SENTINEL knowledge base (ingested runbooks + resolved past incidents) for documents relevant to the current investigation. Returns top-k matches with similarity scores.";
    }
