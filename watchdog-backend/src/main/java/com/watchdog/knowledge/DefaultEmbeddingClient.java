 ...
 *
 * Behavior:
 *  - If {@code watchdog.knowledge.embedding-base-url} is configured, POSTs to
...
public class DefaultEmbeddingClient implements EmbeddingClient {
    ...
    public DefaultEmbeddingClient(WebClient defaultWebClient, WatchdogProperties properties) {
