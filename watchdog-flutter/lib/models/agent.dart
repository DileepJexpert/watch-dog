// Mirrors the React types in watchdog-frontend/src/types/agent.ts and the
// backend FR-9 contract at com.watchdog.agent.dto.AgentAnswer.
...
/// Envelope WATCHDOG sends to /topic/agent/{sessionId} during streaming.
